class MediaPlayer {
    constructor(opts) {
        ...
        const media = document
            .getElementById(modalElementId)
            .querySelector(type);
        const mediaControls = document
            .getElementById(modalElementId)
            .querySelector(".media_controls");
        const playpause = document
            .getElementById(modalElementId)
            .querySelector(".playpause");
        const volumeIcon = document
            .getElementById(modalElementId)
            .querySelector(".volume_icon");
        const volume = document
            .getElementById(modalElementId)
            .querySelector(".volume");
        const volumeBar = document
            .getElementById(modalElementId)
            .querySelector(".volume_bar");
        ...
        const fullscreen = document
            .getElementById(modalElementId)
            .querySelector(".fs");
        const mediaTime = document
            .getElementById(modalElementId)
            .querySelector(".media_time");
        ...
        this.handleFullscreen = () => {
            if (document.fullscreenElement) {
                ...
                mediaContainer.removeEventListener(
                    "mousemove",
        ...
        this.updateVolume = (x) => {
            let vol =
                (x -
                    (volumeBar.offsetLeft +
                        volumeBar.offsetParent.offsetLeft)) /
            ...
            volumeBar.style.clip =
                "rect(0px, " + (vol * 100) / 20 + "vw,2vh,0px)";
            media.volume = vol;
        ...
        media.addEventListener("timeupdate", () => {
            progressBar.style.width =
                Math.floor((media.currentTime / media.duration) * 100) + "%";
